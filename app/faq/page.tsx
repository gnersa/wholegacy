...
const faqJsonLd = {
  ...
  "@type": "FAQPage",
  "mainEntity": content.sections.map(([question, answer]: [string, string]) => ({
    "@type": "Question",
    "name": question,
    "acceptedAnswer": {
      "@type": "Answer",
