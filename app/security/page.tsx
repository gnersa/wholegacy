...
const jsonLd = {
  ...
  "name": content.title,
  "description": content.description,
  "url": `https://wholegacy.com/security`,
  "isPartOf": {
    "@type": "WebSite",
    "name": "WHOLEGACY",
